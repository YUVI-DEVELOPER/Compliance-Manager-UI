...
export const PAGE_HEADER_CONFIG: Record<NavPage, PageHeaderPreset> = {
  ...
  "user-management": {
    ...
    breadcrumbs: withRoot("Security", "User Management"),
    sectionLabel: "Security",
    title: "User Management",
    subtitle: "Create users, manage account status, and assign roles.",
    searchEnabled: false,
  },
  "role-management": {
    page: "role-management",
    breadcrumbs: withRoot("Security", "Role Management"),
    sectionLabel: "Security",
    title: "Role Management",
    subtitle: "Create roles and assign permission sets.",
    searchEnabled: false,
  },
  "permission-management": {
    page: "permission-management",
    breadcrumbs: withRoot("Security", "Permissions"),
    sectionLabel: "Security",
    title: "Permissions",
  ...
  "asset-releases": {
    page: "asset-releases",
    breadcrumbs: withRoot("Operations", "Asset Releases"),
    sectionLabel: "Operations",
    title: "Asset Releases",
    subtitle: "Manage release records, version details, configuration reports, and release workflow outside Asset Master.",
    searchPlaceholder: "Search release, asset, supplier, version, or configuration...",
    primaryAction: { key: "create-release", label: "Create Release", variant: "default", icon: "plus" },
    secondaryActions: [{ key: "refresh", label: "Refresh", variant: "secondary", icon: "refresh" }],
    searchEnabled: true,
    stats: [
      { key: "releases", label: "Releases", hint: "Visible release records", tone: "blue" },
      { key: "assets", label: "Assets", hint: "Referenced assets", tone: "emerald" },
      { key: "manual", label: "Manual", hint: "Manual documentation", tone: "amber" },
      { key: "online", label: "Online", hint: "Fetched documentation", tone: "violet" },
    ],
  },
  "supplier-evaluations": {
    page: "supplier-evaluations",
    breadcrumbs: withRoot("Operations", "Supplier Evaluations"),
    sectionLabel: "Operations",
    title: "Supplier Evaluations",
    subtitle: "Manage supplier response, scoring, locking, and close workflow outside Asset Master.",
    searchPlaceholder: "Search evaluation, asset, URS, supplier response, or release...",
    primaryAction: { key: "new-evaluation", label: "New Evaluation", variant: "default", icon: "plus" },
    secondaryActions: [{ key: "refresh", label: "Refresh", variant: "secondary", icon: "refresh" }],
    searchEnabled: true,
    stats: [
      { key: "evaluations", label: "Evaluations", hint: "Visible workflows", tone: "blue" },
      { key: "draft", label: "Draft", hint: "Preparation state", tone: "slate" },
      { key: "open", label: "Open", hint: "Collecting responses", tone: "emerald" },
      { key: "locked", label: "Locked / Closed", hint: "Scoring complete", tone: "amber" },
    ],
  },
  "periodic-review": {
  ...
  "document-portal": {
    ...
    breadcrumbs: withRoot("Operations", "Document Portal"),
    sectionLabel: "Operations",
    title: "Document Portal",
    subtitle: "Manage asset-linked authored documents, qualification evidence, linked documents, approvals, publishing, and versioning.",
  ...
  "document-intelligence": {
    ...
    breadcrumbs: withRoot("Intelligence", "Document Intelligence"),
    sectionLabel: "Intelligence",
    title: "Document Intelligence",
    subtitle: "Manage document vectorization, chunks, JSON extraction, process status, refresh, and retry workflow.",
    searchPlaceholder: "Search document, asset, source, type, status, or vectorization message...",
    secondaryActions: [{ key: "refresh", label: "Refresh", variant: "secondary", icon: "refresh" }],
    searchEnabled: true,
    stats: [
      { key: "documents", label: "Documents", hint: "Tracked records", tone: "blue" },
      { key: "completed", label: "Completed", hint: "Vectorized", tone: "emerald" },
      { key: "active", label: "Active", hint: "Queued or processing", tone: "amber" },
      { key: "failed", label: "Failed", hint: "Needs retry", tone: "violet" },
    ],
  },
  "lookup-master": {
    page: "lookup-master",
